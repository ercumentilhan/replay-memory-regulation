...
class ReplayBuffer(object):
    def __init__(self, size):  # is_extended: contains meta information
    ...
    def add(self, obs_t, action, reward, obs_tp1, done, source=None, state_t=None):
        old_data = None
        data = (obs_t, action, reward, obs_tp1, done, source, state_t)
    ...
    def _encode_sample(self, idxes):
        obses_t, actions, rewards, obses_tp1, dones, sources = [], [], [], [], [], []
        for i in idxes:
            data = self._storage[i]
            obs_t, action, reward, obs_tp1, done, source, _ = data
